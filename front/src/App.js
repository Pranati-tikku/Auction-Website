...
function App() {
  ...
  useEffect(() => {
    axios
      .get("https://localhost:33123/auth/validate", {
        headers: {
            ...
            {!authState.status ? (
              <>
                ...
                <Route
                  ...
                  element={
                    <>
                      <Navbar clicked={"profile"} /> <NotAllowed />
                    </>
                  }
                />
                <Route
                  ...
                  element={
                    <>
                      <Navbar clicked={"home"} /> <NotAllowed />
                    </>
                  }
                />
              </>
                ...
                {!(authState.username === "admin") ? (
                  <>
                    <Route
                      ...
                      element={
                        <>
                          <Navbar clicked={"createitem"} /> <CreateItem />
                        </>
                      }
                    />
                    <Route
                  ...
                  <>
                    ...
                    <Route
                      ...
                      element={
                        <>
                          <Navbar clicked={"addcategory"} /> <CreateCategory />
                        </>
                      }
                    />
                  </>
